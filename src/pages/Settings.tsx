                    ...
                    <tr key={user.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-4 py-3">
                        <button
                          ...
                          disabled={user.id === profile?.id || user.id !== '3afb33a2-4a42-4679-ace8-fe82ac60630a' && profile?.id !== '3afb33a2-4a42-4679-ace8-fe82ac60630a'}
                          className="text-red-600 hover:text-red-800 disabled:text-gray-400 disabled:cursor-not-allowed"
                          title={user.id === profile?.id ? "You cannot delete yourself" : profile?.id !== '3afb33a2-4a42-4679-ace8-fe82ac60630a' ? "Only main admin can delete users" : "Delete user"}
                        >
