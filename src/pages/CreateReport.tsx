  ...
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <h2 className="text-2xl font-bold text-amber-900 mb-6">Create Microbiological Testing Report</h2>
                ...
                <tr key={row.id}>
                  <td className="border border-gray-300 p-1">
                    <input
                      ...
                      className="w-full px-2 py-1 text-sm border-0 focus:ring-1 focus:ring-amber-700"
                      disabled={!!generatedReport}
                    />
                  </td>
                  <td className="border border-gray-300 p-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-700"
                  disabled={!!generatedReport}
                />
              </div>
              <div>
                      ...
                      <tr key={idx}>
                        ...
                        <td className="border border-gray-300 p-2">
                          <input
                            ...
                            className="w-full px-2 py-1 border-0 focus:ring-1 focus:ring-amber-700"
                            disabled={!!generatedReport}
                          />
                        </td>
                        <td className="border border-gray-300 p-2">
                          <input
                            ...
                            className="w-full px-2 py-1 text-center border-0 focus:ring-1 focus:ring-amber-700"
                            disabled={!!generatedReport}
                          />
                        </td>
                        <td className="border border-gray-300 p-2">
                    ...
                    <tr key={idx}>
                      ...
                      <td className="border border-gray-300 p-1">
                        <input
                          ...
                          className="w-full px-1 py-1 border-0 focus:ring-1 focus:ring-amber-700 text-xs"
                          disabled={!!generatedReport}
                        />
                      </td>
                      <td className="border border-gray-300 p-1">
        ...
        <div className="flex gap-3 justify-end">
          <button
            ...
            className="flex items-center gap-2 bg-amber-900 text-white px-6 py-3 rounded-lg hover:bg-amber-700 transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed shadow-sm"
          >
            <FileCheck className="w-5 h-5" />
